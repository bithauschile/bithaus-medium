 ...
 * @author jmakuc
 */
public class MediumMessagingServiceConsumerRecord {
     ...
     */
    public MediumMessagingServiceConsumerRecord(String key, String value, String topic) {
     ...
     */
    public MediumMessagingServiceConsumerRecord(String key, String value, String topic, Map<String,String> headers) {
     ...
     */
    public MediumMessagingServiceConsumerRecord(String key, String value, String topic, Map<String,String> headers, Long timestamp) {
     ...
     */
    public MediumMessagingServiceConsumerRecord(String key, String value, String topic, Map<String,String> headers, Long timestamp, Integer partition) {
